...
def load_models_and_data():
    kmeans = joblib.load("/home/ec2-user/FoodieGuideAI/Models/kmeans_model.pkl")
    cuisines_encoder = joblib.load("/home/ec2-user/FoodieGuideAI/Models/encoded_cuisines.pkl")
    city_encoder = joblib.load("/home/ec2-user/FoodieGuideAI/Models/label_encoder_city.pkl")
    scaler = joblib.load("/home/ec2-user/FoodieGuideAI/Models/scaler.pkl")
    Final_df = pd.read_csv("/home/ec2-user/FoodieGuideAI/Processed_data1/Final_df1.csv")
