...
def load_models_and_data():
    ...
    cuisines_encoder = joblib.load(r"encoded_cuisines.pkl")
    city_encoder = joblib.load(r"label_encoder_city.pkl")
    scaler = joblib.load(r"scaler.pkl")
    Final_df = pd.read_csv(r"Final_df1.csv")
...
# Filter cuisines based on selected city
available_cuisines = []
if city_input:
...
# Remove duplicate restaurant recommendations
