...
def load_models_and_data():
    kmeans = joblib.load("required_pkl/kmeans_model.pkl")
    cuisines_encoder = joblib.load("required_pkl/encoded_cuisines.pkl")
    city_encoder = joblib.load("required_pkl/label_encoder_city.pkl")
    scaler = joblib.load("required_pkl/scaler.pkl")
    Final_df = pd.read_csv("processed_data/Final_df1.csv")
